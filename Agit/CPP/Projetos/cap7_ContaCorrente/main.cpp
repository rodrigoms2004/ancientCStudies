...
Conta *getConta(vetor &vc, int &codigoCodigoCorrentista);
...
/*
    ...
    Conta conta1;
    conta1.setCondigoCorrentista(1);
    conta1.setNome("Rodrigo");
    conta1.setAgencia("Morumbi");
    conta1.setCC("7888881");
    conta1.depositar(200);
    conta1.sacar(100);
    conta1.imprimir();

    Conta *conta2 = new Conta;
    conta2->setCondigoCorrentista(2);
    conta2->setNome("Teste");
    conta2->setAgencia("Butanta");
    conta2->setCC("44556790");
