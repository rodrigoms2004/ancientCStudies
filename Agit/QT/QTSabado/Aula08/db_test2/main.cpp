...
int main(int argc, char *argv[])
{
    ...
    str = "CREATE TABLE alunos (id INTEGER KEY AUTO_INCREMENT, nome VARCHAR(250), cidade VARCHAR(40))";
    if (!query.exec(str)) {
        std::cerr << "Não foi possivel excluir a tabela";
    }


    query.prepare("INSERT INTO alunos (nome, cidade) VALUES (?, ?)");
    query.bindValue(0, "Jose da Silva");
    query.bindValue(1, "São Paulo");
    query.exec();
