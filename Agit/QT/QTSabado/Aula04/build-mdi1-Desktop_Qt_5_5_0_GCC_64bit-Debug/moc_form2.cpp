...
const QMetaObject form2::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_form2.data,
      qt_meta_data_form2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *form2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_form2.stringdata0))
        return static_cast<void*>(const_cast< form2*>(this));
